...
FoodItem — represents an individual menu item with name, price, category, and popularity rating
Menu — represents the full collection of FoodItems, with the ability to filter by category
Order — represents a single transaction grouping selected items and computing the total cost